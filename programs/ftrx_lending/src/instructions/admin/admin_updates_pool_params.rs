...
pub fn handle(
    ctx: Context<AdminUpdatesPoolParams>,
    bump: u8,
    ...
    simple_pool_element.volatile_share_mint_decimal=6;
    simple_pool_element.stable_share_mint_decimal=6;
    ...
    simple_pool_element.stable_deposited=0;
    simple_pool_element.volatile_deposited=0;

    simple_pool_element.stable_borrowed=0;
    simple_pool_element.volatile_borrowed=0;

    simple_pool_element.stable_net=0;
    simple_pool_element.volatile_net=0;

    simple_pool_element.stable_share=0;
    simple_pool_element.volatile_share=0;
